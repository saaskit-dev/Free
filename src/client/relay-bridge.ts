...
function printHelp(): void {
  process.stdout.write(
    [
      "Usage:",
      "  free bridge run [--relay-env online|local]",
      "  free bridge run [--relay-url <ws-url>]",
      "  free bridge config [--relay-env online|local] [--command <path>] [--zed|--all]",
      ...
      "  FREE_RELAY_ENV              Relay environment name: online or local",
